...
namespace BildirimTestApp.Server.Servisler.OturumYonetimi
{
    public class OturumYonetimi : IOturumYonetimi
    {
        ...
        public async Task<bool> KullaniciSil(string kullanicAdi)
        {
            var user = await _kullaniciBilgiServisi.TryGetKullaniciBilgiAsync(kullanicAdi);
            ...
            _context.SisKullanicis.Remove(user);
            await _context.SaveChangesAsync();
            return true;
        }
    }
